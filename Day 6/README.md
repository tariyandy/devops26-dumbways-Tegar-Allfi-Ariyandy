...
4. Ketika nginx telah berjalan, masuk kembali ke directory `/etc/nginx`, dan cek apakah folder `sites-available` tersedia atau tidak.
   
   <img width="755" height="110" alt="image" src="https://github.com/user-attachments/assets/4493d977-fff9-40ba-b22f-a20b4e0140c0" />

5. Daftarkan kembali dengan membuat file baru bernama `wayshub_frontend.conf` dan memasukkan server name dan lokasi proxy nya seperti gambar berikut.
   
   <img width="755" height="139" alt="image" src="https://github.com/user-attachments/assets/40a4bd52-800d-4bcd-bc65-c5d73153730e" />

6. Setelah server name dan lokasi proxy dimasukkan, selanjutkan lakukan pengecekan apakah konfigurasi nginx sudah benar dengan `sudo nginx -t`.
